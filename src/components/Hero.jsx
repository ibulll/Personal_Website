...
const Hero = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      >
        <div
          className={`flex-col my-auto mx-auto relative z-20 transition-all duration-1000 ease-in-out ${
            animate ? "opacity-100 transform translate-x-0" : "opacity-0 transform -translate-x-10"
          }`}
        >
          ...
          <h1 className="md:text-7xl sm:text-6xl text-4xl font-bold md:py-6">
            <TypeAnimation
              sequence={["Junior", 1000, "Web Developer", 1000]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
          ...
          <div className="text-5xl flex justify-start gap-16 my-7 text-purple-600">
            ...
            <a
              href="https://www.instagram.com/ilhamardnms/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-gray-400 transition duration-300 ease-in-out"
            >
        ...
        <div
          className={`my-auto transition-all duration-1000 ease-in-out ${
            animate ? "opacity-100 transform translate-x-0" : "opacity-0 transform translate-x-10"
          }`}
        >
          <img
            className="w-[300px] sm:w-[450px] mx-auto h-auto rounded-full transition duration-300 ease-in-out"
            src={Foto}
            alt="Profil"
          />
        </div>
